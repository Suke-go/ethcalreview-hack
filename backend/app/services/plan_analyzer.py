...
- アンケート生成に使えるよう、研究方法には条件、課題、測定内容を具体的に含めてください。
- 字幕・音声・韻律・講演理解に関する研究の場合は、字幕条件、講演クリップ、理解確認、強調語同定、態度・意図推定、主観的負荷評価、条件順序のカウンターバランスを考慮してください。
...
{{
    ...
    "participant_count": 0,
    "participant_count_reason": "人数設定の根拠。根拠が不明なら空文字。",
    "age_range": "18歳以上の成人",
